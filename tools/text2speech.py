...
def concatenate_strings(input_strings):
    """
    concatenate strings to fit the 500 character limit
    """
    result = []
...
def concatenate_wav_files(input_files, output_file):
    """
    This function concatenates multiple WAV files into a single WAV file.
    """
...
def get_speech_from_text(text, filename=None):
    """
    Text to speech using Genny API
    """
  
    speaker = "63b407a8241a82001d51b977"
    speed = 1.1
    API_key= "9e6046c7-72a4-4e44-b0bb-4560d287998f"
